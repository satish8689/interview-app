...
const filePath = process.env.NEXT_PUBLIC_GITHUB_FILE_PATH+'/qa.json';
...
export default async function handler(req, res) {
  try {
    ...
    if (
      ...
      const uploadDir = path.join(process.cwd(), 'public', 'sahaj-optical');
      ...
      form.parse(req, (err, fields, files) => {
        ...
        const filePath = `/sahaj-optical/${fileName}`;
